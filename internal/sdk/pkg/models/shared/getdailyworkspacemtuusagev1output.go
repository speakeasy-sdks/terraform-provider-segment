...
// GetDailyWorkspaceMTUUsageV1OutputPaginationOutput - Pagination metadata for a list response.
//
...
type GetDailyWorkspaceMTUUsageV1OutputPaginationOutput struct {
