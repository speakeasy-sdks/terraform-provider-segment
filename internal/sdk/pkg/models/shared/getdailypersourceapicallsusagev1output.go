...
// GetDailyPerSourceAPICallsUsageV1OutputPaginationOutput - Pagination metadata for a list response.
//
...
type GetDailyPerSourceAPICallsUsageV1OutputPaginationOutput struct {
