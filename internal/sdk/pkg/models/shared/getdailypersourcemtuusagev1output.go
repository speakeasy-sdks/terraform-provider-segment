...
// GetDailyPerSourceMTUUsageV1OutputPaginationOutput - Pagination metadata for a list response.
//
...
type GetDailyPerSourceMTUUsageV1OutputPaginationOutput struct {
