...
import (
	"context"
	"fmt"
	"github.com/scentregroup/terraform-provider-segment/internal/sdk/internal/hooks"
	"github.com/scentregroup/terraform-provider-segment/internal/sdk/internal/utils"
...
func New(opts ...SDKOption) *Segment {
	sdk := &Segment{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.291.0",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.291.0 36.2.0 github.com/scentregroup/terraform-provider-segment/internal/sdk",
			Hooks:             hooks.New(),
		},
	}
